<template>
  <div class="activity-sidebar w-96 bg-white rounded-lg shadow-lg ml-4 p-4 flex flex-col">
...
const popularPlaces = ref([
  ...
  { 
    id: 3, 
    name: 'Times Square', 
    description: 'Major commercial intersection, tourist destination, entertainment center'
  },
  { 
    id: 4, 
  ...
  { 
    ...
    description: 'Historic hybrid cable-stayed/suspension bridge in New York City'
  }
])
